...
import { useState, type DOMAttributes, type FormEvent, type SubmitEventHandler } from "react"
...
export const LoginPage = () => {
    ...
    const handleFormSubmit = async (e: React.SubmitEvent<HTMLFormElement>) => {
        ...
        toast.error('Correo y/o contraseña no válido')
        setIsPosting(false)
    }
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="text-balance text-center text-xs text-muted-foreground [&_a]:underline [&_a]:underline-offset-4 hover:[&_a]:text-primary">
                Haciendo click en cotinuar, ud acepta los <a href="#">Términos de servicio</a> y <a href="#">Política de privacidad</a>.
            </div>
        </div>
    )
}
